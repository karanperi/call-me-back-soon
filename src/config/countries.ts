// Complete list of countries with ISO codes, names, dial codes, and flag emojis
// Supports all countries that Twilio supports for voice calls

export interface Country {
  code: string;      // ISO 3166-1 alpha-2 (e.g., "GB", "IN", "US")
  name: string;      // Full name (e.g., "United Kingdom")
...
// Helper function to find a country by ISO code
...
export function getCountryByDialCode(dialCode: string): Country | undefined {
  ...
  const exactMatch = ALL_COUNTRIES.find((c) => c.dialCode === dialCode);
  if (exactMatch) return exactMatch;
  
  // For dial codes shared by multiple countries (like +1), prefer US
  if (dialCode === "+1") {
